function openAlbumInfo(albumtoshowcase){
	...
	history.pushState("Album: "+albumtoshowcase, "Album: "+albumtoshowcase, "http://brzoskwinia.wpww.pl/?"+langapp+"a="+albumtoshowcase.replace(/'/g, "%27"));
...
function openSongInfo(songtoshowcase){
	...
	history.pushState("Song: "+songtoshowcase, "Song: "+songtoshowcase, "http://brzoskwinia.wpww.pl/?"+langapp+"s="+songtoshowcase.replace(/'/g, "%27"));
...
function closeInfo(whatinfo){
	...
	if(whatinfo == ".albumdetails"){ //jeśli zamykam ostatnią, wyczyść adres
	    history.pushState("Song list", "Song list", "http://brzoskwinia.wpww.pl/");
